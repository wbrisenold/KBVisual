  ...
  return (
    <footer style={{ backgroundColor: "#f5f5f5" }} className="border-t border-yellow-700 border-opacity-20 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/about" className="text-stone-700 opacity-80 hover:text-yellow-700 transition-colors duration-300">
                  About
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-stone-700 opacity-80 hover:text-yellow-700 transition-colors duration-300">
                  Pricing
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href={SCHEDULING_URL} target="_blank" rel="noopener noreferrer" className="text-stone-700 opacity-80 hover:text-yellow-700 transition-colors duration-300">
                  Plan a session
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-yellow-700 border-opacity-20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
